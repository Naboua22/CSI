<x-app-layout>
    <x-slot name="header">
        <h2 class="text-xl font-semibold leading-tight text-gray-800">
            {{ __('Création d\'un programme academique') }}
        </h2>
    </x-slot>
    ...
    <div>
        <div class="max-w-7xl sm:px-6 lg:px-8 lg:mx-auto mx-4">
            ...
            <form class="space-y-8 divide-y divide-gray-200" method="POST" action="{{ route('program.store') }}" >
                @csrf
                    ...
                    <div>
                        ...
                        <div class="space-y-6 sm:space-y-5">
                            ...
                            <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                                ...
                                <div class="mt-1 sm:mt-0 sm:col-span-2">
                                <input type="text" name="filiere" id="filiere" autocomplete="given-name" class="block w-full  border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                </div>
                            </div>
